    ...
    <BContainer fluid>
        ...
        <ul class="navbar-nav h-100" id="navbar-nav">
            ...
            <tempalte v-if="$page.props.roles.includes('Administrator')">
                ...
                <li class="nav-item">
                    <Link href="/organization" class="nav-link menu-link"
                    :class="{'active': $page.component.startsWith('Modules/Administrator/Signatories') }">
                    <i class="ri-building-2-fill"></i>
                    <span class="fw-semibold fs-14" data-key="t-dashboards">Organization</span>
                    </Link>
                </li>
                <li class="nav-item">
                   ...
                   :class="{'active': $page.url.startsWith('Modules/System/References') }"
                    ...
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <Link href="/references/units" :class="{'active': $page.component.startsWith('Modules/System/References/Units') }" class="nav-link" data-key="t-basic">
                                    Units
                                </Link>
                            </li>
                            <li class="nav-item">
                                <Link href="/references/positions" :class="{'active': $page.component.startsWith('Modules/System/References/Positions') }" class="nav-link" data-key="t-basic">
                                    Positions
                                </Link>
                            </li>
                            <li class="nav-item">
                               <Link href="/references/leaves" :class="{'active': $page.component.startsWith('Modules/System/References/Leaves') }" class="nav-link" data-key="t-basic">
                                    Leaves
                                </Link>
                            </li>
                            <li class="nav-item">
                                <Link href="/references/salaries" :class="{'active': $page.component.startsWith('Modules/System/References/Salaries') }" class="nav-link" data-key="t-basic">
                                    Salaries
                                </Link>
                            </li>
                            <li class="nav-item">
                                <Link href="/references/deductions" :class="{'active': $page.component.startsWith('Modules/System/References/Deductions') }" class="nav-link" data-key="t-basic">
                                    Deductions
                                </Link>
                            </li>
                            <li class="nav-item">
                                <Link href="/references/dropdowns" :class="{'active': $page.component.startsWith('Modules/System/References/Dropdowns') }" class="nav-link" data-key="t-basic">
                                    Dropdowns
                                </Link>
                            </li>
                        </ul>

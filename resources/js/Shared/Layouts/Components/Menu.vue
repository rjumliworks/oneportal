      ...
      <tempalte v-if="$page.props.roles.includes('Administrator')">
        ...
        <li class="nav-item">
          <Link
            ...
            class="nav-link menu-link"
            :class="{
              active: $page.component.startsWith('Modules/Administrator/Signatories'),
            }"
          >
            ...
            <ul class="nav nav-sm flex-column">
              <li class="nav-item">
                <Link
                  ...
                  :class="{
                    active: $page.component.startsWith('Modules/System/References/Units'),
                  }"
                  class="nav-link"
                  data-key="t-basic"
                >
              ...
              <li class="nav-item">
                <Link
                  ...
                  :class="{
                    active: $page.component.startsWith(
                      'Modules/System/References/Positions'
                    ),
                  }"
                  class="nav-link"
                  data-key="t-basic"
              ...
              <li class="nav-item">
                <Link
                  ...
                  :class="{
                    active: $page.component.startsWith(
                      'Modules/System/References/Leaves'
                    ),
                  }"
                  class="nav-link"
                  data-key="t-basic"
              ...
              <li class="nav-item">
                <Link
                  ...
                  :class="{
                    active: $page.component.startsWith(
                      'Modules/System/References/Salaries'
                    ),
                  }"
                  class="nav-link"
                  data-key="t-basic"
              ...
              <li class="nav-item">
                <Link
                  ...
                  :class="{
                    active: $page.component.startsWith(
                      'Modules/System/References/Deductions'
                    ),
                  }"
                  class="nav-link"
                  data-key="t-basic"
              ...
              <li class="nav-item">
                <Link
                  ...
                  :class="{
                    active: $page.component.startsWith(
                      'Modules/System/References/Dropdowns'
                    ),
                  }"
                  class="nav-link"
                  data-key="t-basic"

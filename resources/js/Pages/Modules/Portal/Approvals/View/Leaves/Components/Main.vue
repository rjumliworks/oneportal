                                        ...
                                        <div v-if="information.comments.length > 0" class="card-body bg-white rounded-bottom" style="height: calc(100vh - 592px); overflow: auto;">
                                            <div class="d-flex mb-4" :class="{ 'border-bottom': index !== information.comments.length - 1 }" v-for="(list,index) in information.comments" v-bind:key="index">
                                                <div class="flex-shrink-0">
                                                    <img :src="list.avatar" alt="" class="img-thumbnail avatar-xs rounded-circle" />
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <div class="d-flex" :class="index2 === 0 ? 'mt-4' : 'mt-1'" v-for="(sub,index2) in list.replies" v-bind:key="index2">
                                                        <div class="flex-shrink-0">
                                                            <img :src="sub.avatar" alt="" class="img-thumbnail avatar-xs rounded-circle" />
                                                        </div>
...
export default {
    components: { simplebar, Multiselect, Signatories, Attachment, Detail },
    props: ['information'],
    data(){
        return {
            form: useForm({

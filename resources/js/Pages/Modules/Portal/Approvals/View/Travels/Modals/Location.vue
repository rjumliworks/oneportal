<template>
    <b-modal v-model="showModal" style="--vz-modal-width: 550px;" header-class="p-3 bg-light" :title="(editable) ? 'Update Destination' : 'Add Destination'" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>

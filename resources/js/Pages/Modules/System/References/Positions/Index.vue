                    ...
                    <b-row class="mb-2 ms-1 me-1" style="margin-top: 12px;">
                        <b-col lg>
                            <div class="input-group mb-1">
                                ...
                                <Multiselect class="white" style="width: 20%;" :options="salaries" v-model="salary" label="name" :searchable="true" placeholder="Select Salary" />
                        ...
                        <div class="flex-grow-1">
                            <ul class="nav nav-tabs nav-tabs-custom nav-primary fs-12" role="tablist">
                                <li class="nav-item">
                                    ...
                                    <i class="ri-apps-2-line me-1 align-bottom"></i> All Positions
                                    </BLink>
                                </li>
                            </ul>
                        </div>
                        ...
                        <table class="table align-middle table-striped table-centered mb-0">
                            <thead class="table-light thead-fixed">
                                <tr class="fs-11">
                                    ...
                                    <th>Position</th>
                                    <th style="width: 13%;" class="text-center">Short Term</th>
                                    <th style="width: 5%;" class="text-center">Grade</th>
                                    <th style="width: 10%;" class="text-center">Salary</th>
                            ...
                            <tbody class="table-white fs-12">
                                <tr v-for="(list,index) in filteredLists" v-bind:key="index" @click="selectRow(index)">
                                    ...
                                    <td>
                                        ...
                                        <!-- <p class="fs-12 text-muted mb-0">{{list.salary.amount}}</p> -->
                                    </td>
                                    <td class="text-center">{{ list.short }}</td>
                                    <td class="text-center">{{ list.salary.grade }}</td>
                                    <td class="text-center">{{ list.salary.amount }}</td>
    ...
    computed: {
        filteredLists() {
            let filtered = this.lists.filter(item => {
                ...
                const matchesDivision = !this.salary || item.salary.id === this.salary;

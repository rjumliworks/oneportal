<template>
  ...
  <!-- Main Content -->
  <div class="chat-wrapper gap-1" style="height: 450px">
    <b-card class="W-100 h-100">
      <!-- Purchase Order Content -->
      <div
        v-if="purchase_order"
        class="file-manager-content p-4 pb-0"
        ...
        <b-row class="mb-3">
          ...
          <b-col>
            <div class="d-flex flex-column">
              ...
              <span
                >Status:
                <b-badge :class="purchase_order.status.bg">
                  {{ purchase_order.status?.name }}</b-badge
                >
              </span>
            </div>
          </b-col>

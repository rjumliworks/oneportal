<template>
  ...
  >
    <form class="customform">
      <BRow>
        ...
        <BCol lg="6" class="mt-2">
          ...
          <TextInput
            v-model="noa.procurement_quotation.supplier.name"
            type="text"
            class="form-control"
            :light="true"
            readonly
    ...
    <template v-slot:footer>
      ...
      <b-button @click="submit()"  variant="primary" :disabled="form.processing || !form.place_of_delivery_id" block
        >Save</b-button
      >
    </template>
  </b-modal>
  ...
  data() {
    return {
      ...
      form: useForm({
        ...
        po_date: null,
        code: null,
        supplier_address: this.noa.procurement_quotation.supplier.address?.address,

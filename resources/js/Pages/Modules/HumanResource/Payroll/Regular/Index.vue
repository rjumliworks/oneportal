            ...
            <div class="card-header bg-light-subtle">
                <div class="d-flex mb-n3">
                    ...
                    <div class="flex-grow-1">
                        <h5 class="mb-0 fs-14"><span class="text-body">Regular Employees Payroll</span></h5>
                        <p class="text-muted text-truncate-two-lines fs-12">Manage and review payroll records for regular employees, including salary details, deductions, and net pay summaries.</p>
                    </div>
                    ...
                    <table class="table align-middle table-striped table-centered mb-0">
                        ...
                        <tbody class="table-white fs-12" v-if="lists.length > 0">
                            <tr v-for="(list,index) in lists" v-bind:key="index" >
                                ...
                                <td class="text-end">
                                    <Link :href="`/payroll/regular/${list.code}`">

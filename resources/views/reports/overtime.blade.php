...
<body>
    ...
    <div class="footer">
        ...
        <table style="margin-top: -5px; border-bottom-style: hidden; border-right-style: hidden; border-top-style: hidden; border-left-style: hidden;">
            <tr>
                ...
                <td style="border-right-style: hidden;" style="width: 50%; text-align: left; font-size: 10px;"><br/> <span style="font-weight: bold; color: #072388;">asda</span></td>
    ...
    <div class="content">
            ...
            <div style="font-family:Arial;">
                ...
                <br/>
                <center style="margin-top: 8px; font-size: 11px;  color:#000; font-weight: bold; padding: 2px;">RENDER OVERTIME SERVICE</center>
            ...
            <h6 style="font-size: 10px; margin-top: 12px;">PURPOSE & TARGET :</h6>
            ...
            <tbody>
                ...
                <tr style="text-align: center;">
                    <td width="33.3%">
                        ...
                        @else
                            @if($signatory['is_approval_only'] === 0)
                            {{ $signatory['recommended']['profile']['fullname']}}</span>
                    ...
                    <td width="33.3%"><span style="font-weight: bold; font-size: 11px; color: #072388; text-transform: uppercase;">
                        {{ $signatory['approved']['profile']['fullname']}}</span><hr style="margin-top: 0px; margin-bottom: 1px; border: .1px solid black; width: 80%;">

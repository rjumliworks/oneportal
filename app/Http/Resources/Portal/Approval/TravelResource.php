...
class TravelResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'status' => ($this->request->type->name == 'Travel Order') ? $this->status : $this->request->status,
            ...
            'codes' => $this->request->travel->odes,
            ...
            'statuses' => StatusResource::collection($this->request->statusable),
